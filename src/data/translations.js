export const translations = {
  en: {
    ...
    offers: {
      ...
      description: 'Get fresh, healthy, self-heating meals delivered daily to your door. Choose from our flexible 26-day subscription plans.',
      viewPlans: 'View Plans',
      browseMenu: 'Browse Menu',
      daysSubscription: 'Days Subscription',
      limitedOffer: 'Limited Launch Offer',
      withFreeDelivery: 'with Free Delivery',
      whySubscribe: 'Why Subscribe?',
      whySubscribeDesc: 'Join thousands of happy customers who enjoy convenient, healthy meals every day.',
      benefit1Title: 'Save Money',
      benefit1Desc: 'Subscribe and save compared to individual purchases. The longer you subscribe, the more you save.',
      benefit2Title: 'Flexible Delivery',
      benefit2Desc: 'Daily delivery of fresh meals. Skip, pause, or cancel anytime with no commitment.',
      benefit3Title: 'Premium Quality',
      benefit3Desc: 'Every meal is prepared with fresh ingredients and our innovative self-heating technology.',
      choosePlan: 'Choose Your Plan',
      choosePlanDesc: 'Select the subscription that fits your lifestyle. All plans are for 26 days with free delivery.',
      mostPopular: 'Most Popular',
      oneMealPlan: '1 Meal',
      twoMealsPlan: '2 Meals',
      threeMealsPlan: '3 Meals',
      twoMealsSaladPlan: '2 Meals + Salad',
      twoMealsSaladPuddingPlan: 'Full Package',
      ...
      howItWorksDesc: 'Getting started with your meal subscription is easy.',
      step1Title: 'Choose Your Plan',
      step1Desc: 'Select the subscription plan that best fits your daily meal needs.',
      step2Title: 'Set Your Schedule',
      step2Desc: 'Choose your preferred delivery time and start date.',
      step3Title: 'Daily Delivery',
      step3Desc: 'Fresh meals delivered to your door every day for 26 days.',
      step4Title: 'Heat & Enjoy',
      step4Desc: 'Self-heating meals ready in just 3-5 minutes.',
      ctaTitle: 'Ready to Start Your Plan?',
      ctaDesc: 'Join our 26-day subscription plan today and enjoy healthy, delicious meals delivered daily.',
      getStarted: 'Get Started',
      contactUs: 'Contact Us',
      // Subscription Form Modal
      subscribeNow: 'Subscribe Now',
      subscriptionForm: 'Complete Your Subscription',
      formName: 'Full Name',
      formNamePlaceholder: 'Enter your full name',
      formPhone: 'Phone Number',
      formPhonePlaceholder: '+966 5XX XXX XXXX',
      formEmail: 'Email Address',
      formEmailPlaceholder: 'your.email@example.com',
      submitSubscription: 'Submit Subscription',
      submitting: 'Submitting...',
      successTitle: 'Thank You!',
      successMessage: 'Thanks for your subscription! We\'re going to contact you soon.',
      closeModal: 'Close',
  ...
  ar: {
    ...
    offers: {
      tagline: 'عروض خاصة',
      title: 'خطط الاشتراك',
      titleHighlight: 'في الوجبات',
      description: 'احصل على وجبات صحية طازجة ذاتية التسخين تُوصل يومياً إلى بابك. اختر من خططنا المرنة لمدة 26 يوماً.',
      viewPlans: 'عرض الخطط',
      browseMenu: 'تصفح القائمة',
      daysSubscription: 'يوم اشتراك',
      limitedOffer: 'عرض إطلاق محدود',
      withFreeDelivery: 'مع توصيل مجاني',
      whySubscribe: 'لماذا تشترك؟',
      whySubscribeDesc: 'انضم إلى آلاف العملاء السعداء الذين يستمتعون بوجبات صحية ومريحة كل يوم.',
      benefit1Title: 'وفر المال',
      benefit1Desc: 'اشترك ووفر مقارنة بالشراء الفردي. كلما طالت مدة اشتراكك، وفرت أكثر.',
      benefit2Title: 'توصيل يومي',
      benefit2Desc: 'توصيل يومي للوجبات الطازجة. تخطَّ أو أوقف أو ألغِ في أي وقت بدون التزام.',
      benefit3Title: 'جودة ممتازة',
      benefit3Desc: 'كل وجبة محضرة بمكونات طازجة وتقنية التسخين الذاتي المبتكرة.',
      choosePlan: 'اختر خطتك',
      choosePlanDesc: 'اختر الاشتراك الذي يناسب أسلوب حياتك. جميع الخطط لمدة 26 يوماً مع توصيل مجاني.',
      mostPopular: 'الأكثر شيوعاً',
      oneMealPlan: 'وجبة واحدة',
      twoMealsPlan: 'وجبتان',
      threeMealsPlan: '3 وجبات',
      twoMealsSaladPlan: 'وجبتان + سلطة',
      twoMealsSaladPuddingPlan: 'الباقة الكاملة',
      mealsPerDayLabel: 'وجبات / يوم',
      totalMealsLabel: 'إجمالي الوجبات',
      meal: 'وجبة',
      bundleValue: 'قيمة الباقة',
      premium: 'مميز',
      selectPlan: 'اختر الخطة',
      howItWorks: 'كيف يعمل',
      howItWorksDesc: 'البدء مع اشتراك الوجبات سهل.',
      step1Title: 'اختر خطتك',
      step1Desc: 'اختر خطة الاشتراك التي تناسب احتياجاتك اليومية.',
      step2Title: 'حدد جدولك',
      step2Desc: 'اختر وقت التوصيل المفضل وتاريخ البدء.',
      step3Title: 'توصيل يومي',
      step3Desc: 'وجبات طازجة تُوصل إلى بابك يومياً لمدة 26 يوماً.',
      step4Title: 'سخن واستمتع',
      step4Desc: 'وجبات ذاتية التسخين جاهزة في 3-5 دقائق فقط.',
      ctaTitle: 'مستعد لبدء خطتك؟',
      ctaDesc: 'انضم إلى خطة الاشتراك لمدة 26 يوماً اليوم واستمتع بوجبات صحية ولذيذة تُوصل يومياً.',
      getStarted: 'ابدأ الآن',
      contactUs: 'تواصل معنا',
      // Subscription Form Modal
      subscribeNow: 'اشترك الآن',
      subscriptionForm: 'أكمل اشتراكك',
      ...
      formEmailPlaceholder: 'your.email@example.com',
      submitSubscription: 'إرسال الاشتراك',
      submitting: 'جاري الإرسال...',
      successTitle: 'شكراً لك!',
      successMessage: 'شكراً على اشتراكك! سنتواصل معك قريباً.',
      closeModal: 'إغلاق',
